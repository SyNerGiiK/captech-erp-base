# file: fix_api_tests_unique_names.ps1
# Usage:
#   powershell -ExecutionPolicy Bypass -File .\fix_api_tests_unique_names.ps1
...
# New test content: use ASGITransport + asyncio + UUID suffix to avoid UNIQUE conflicts
$code = @'
import uuid
...
async def test_public_invoice_pdf_success():
    ...
    try:
        ...
        # suffix aléatoire pour éviter tout conflit UNIQUE
